...
session_start(); $_SESSION['activeTab'] = 'boeken'; $activeTab = $_SESSION['activeTab']; include_once("view/navbar.php"); 
...
<body>
    ...
    <?php if (isset($book)): ?>
        ...
        <div class="image">
            <img src="../uploads/<?=$book['image']?>" alt="<?=$book['titel']?>" width="100" onclick="showPopup()">
        </div>
